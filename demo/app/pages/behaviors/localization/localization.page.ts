...
import { SuiLocalizationService, LocalesModule } from "@piratuks/ng-semantic-ui";
...
export class AppComponent {
    constructor(public localizationService:SuiLocalizationService, public locales: LocalesModule) {
        // Load the Spanish translations into the Localization Service.
        localizationService.load("es", this.locales.languages.es);
...
export class AppComponent {
    constructor(public localizationService:SuiLocalizationService, public locales: LocalesModule) {
        ...
        localizationService.load("fr",  this.locales.languages.fr);
...
export class LocalizationExample implements OnDestroy {
  ...
  constructor(public localizationService: SuiLocalizationService, public locales: LocalesModule) {
    ...
    Object.keys(this.locales.languages).forEach((k) => this.localizationService.load(k, this.locales.languages[k]));
  }
