...
import { DatepickerMode } from "@piratuks/ng-semantic-ui";
...
export class DatepickerPage {
      ...
      properties: [
        {
          ...
          type: "DatepickerMode",
          description:
            "Specifies the mode for the datepicker. Options are: <code>datetime</code>, " +
        ...
        },
        {
          ...
          type: "number",
          description:
            "Sets the first day of the week when displaying dates in a month. " +
  ...
  public cssInclude:string = `<link rel="stylesheet" href="https://unpkg.com/semantic-ui-calendar/dist/calendar.min.css">`;
}
