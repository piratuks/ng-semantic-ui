...
import { SuiModalService, ModalTemplate, TemplateModalConfig, ComponentModalConfig, ModalSize, SuiModal } from "@piratuks/ng-semantic-ui";
  ...
  public api: ApiDefinition = [
    {
      ...
      properties: [
        ...
        },
        {
          ...
          type: "boolean",
          description:
            "Whether or not the modal should be always scrolling. " +
...
import {SuiModalService, TemplateModalConfig, ModalTemplate} from '@piratuks/ng-semantic-ui';
...
import {SuiModal, ComponentModalConfig, ModalSize} from "@piratuks/ng-semantic-ui"
