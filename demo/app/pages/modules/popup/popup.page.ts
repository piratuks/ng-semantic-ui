  ...
  public api:ApiDefinition = [
    {
      ...
      properties: [
        ...
        },
        {
          ...
          type: "PopupSize",
          description:
            "Sets the size of the popup. Available options are: <code>mini</code>, " +
        ...
        },
        {
          ...
          type: "PopupWidth",
          description:
            "Sets the width of the popup. Available options are: <code>wide</code>, " + "<code>very wide</code>, <code>flowing</code>"
        },
        {
          name: "popupInverted",
          type: "boolean",
        ...
        },
        {
          ...
          type: "PopupTrigger",
          description:
            "Specifies the trigger for the popup. Options are: <code>hover</code>, " +
        ...
        },
        {
          ...
          type: "IPopupConfig",
          description:
            "Takes an <code>IPopupConfig</code> object that provides " + "values for various configuration options simultaneously."
        }
      ]
    }
  ];
...
import {IPopup} from "@piratuks/ng-semantic-ui";
