...
import { SuiModalService } from "@piratuks/ng-semantic-ui";
  ...
  public api:ApiDefinition = [
    {
      ...
      properties: [
        ...
        },
        {
          ...
          type: "T[]",
          description:
            "Sets the options available to the search component. " + "Cannot be used in conjunction with <code>optionsLookup</code>."
        },
        {
          name: "optionsFilter",
          type: "(options:T[], query:string) => T[] | false",
          description:
            "A function to filter the provided options with a custom function. " +
        ...
        },
        {
          ...
          description:
            "A function to asynchronously transform the provided query string into the array of results. " +
        ...
        },
        {
          ...
          type: "string",
          description:
            "Sets the property name that the search element uses to lookup and " +
...
export const SearchPageComponents = [SearchPage, SearchExampleStandard, SearchExampleRemote, SearchExampleTemplate];
