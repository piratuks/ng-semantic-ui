    ...
    },
    {
      ...
      properties: [
        ...
        },
        {
          ...
          type: "boolean",
          description:
            "Sets whether the tab is active. Supports being set to <code>false</code> " +
        ...
        },
        {
          ...
          type: "boolean",
          description:
            "Sets whether not the tab is disabled. If the tab is active when it is disabled, " + "the closest available tab is activated.",
          defaultValue: "false"
        }
      ],
      events: [
        {
          ...
          type: "boolean",
          description:
            "Fires when the tab's active status is changed. Using the <code>[(isActive)]</code> " +
