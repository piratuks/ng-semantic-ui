...
export class YearMappings extends CalendarMappings {
  constructor() {
    ...
    this.changed = new Map<CalendarViewType, CalendarViewType>([[CalendarViewType.Year, CalendarViewType.Year]]);

    this.zoom = new Map<CalendarViewType, CalendarViewType>([[CalendarViewType.Year, CalendarViewType.Year]]);
  }
}
