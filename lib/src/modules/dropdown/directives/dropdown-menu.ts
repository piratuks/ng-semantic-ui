...
import {
    ...
    IAugmentedElement,
    KeyCode
} from "../../../misc/util/helpers/util";
import {
    Transition,
    TransitionDirection
} from "../../transition/classes/transition";
...
export class SuiDropdownMenu extends SuiTransition implements AfterContentInit, OnDestroy {
  ...
  public set parentElement(value:ElementRef) {
    this._parentKeyDownListener = this._renderer.listen(value.nativeElement, "keydown", (e:KeyboardEvent) =>
